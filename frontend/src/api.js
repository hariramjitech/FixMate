...
// Prevent GET request caching (fixes dashboards not auto-updating on Vercel)
api.defaults.headers.get['Cache-Control'] = 'no-cache, no-store, must-revalidate, proxy-revalidate';
